...
n_graph_feat = 10
nb_epoch = 10
model = WeaveModel(n_tasks = n_tasks, n_atom_feat = n_atom_feat, n_pair_feat = n_pair_feat,
                   n_hidden = n_hidden, n_graph_feat = n_graph_feat, mode = "regression",
                   batch_size=batch_size,
                   model_dir="/home/rod/Dropbox/Quimica/Analysis/ANalisis/Borradores/WeaveModel/") #To prevent overfitting
